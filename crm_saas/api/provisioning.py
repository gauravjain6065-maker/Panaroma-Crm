...
def provision_tenant(job_name: str):
	...
	logger.info(f"Starting provisioning for site '{site_name}' under job '{job_name}'.")
	...
	try:
		...
		logger.error(f"Provisioning failed for site '{site_name}' in job '{job_name}': {tb}")
